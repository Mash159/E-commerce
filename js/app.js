new Vue({
    ...
    data: {
     ...
     methods: {
        ...
        removeItemFromCart: function(cartItam){
            var index = this.cart.items.indexOf(cartItam)
            if (index !==1){
                this.cart.items.splice(index,1);
            }
        },
        decreaseQuantity: function(cartItam){
            cartItam.product.inStock ++;
            cartItam.quantity --;
            if (cartItam.quantity == 0){
                this.removeItemFromCart(cartItam);
            }
        }
     },
     computed: {
